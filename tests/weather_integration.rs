...
async fn test_get_weather_integration() -> Result<()> {
    ...
    // Skip in CI environments (GitHub Actions) where network access may be unreliable or blocked
    // Can also be skipped manually by setting SKIP_INTEGRATION_TESTS=1
